...
You can then execute your native executable with: `./target/exchange-1.0.0-SNAPSHOT-runner`
...
- Amazon SES ([guide](https://docs.quarkiverse.io/quarkus-amazon-services/dev/amazon-ses.html)): Connect to Amazon SES
